...
export class PendingApprovalComponent extends UnSub implements OnInit, AfterViewInit {
        ...
        this.columnDefs = [
          ...
          { field: 'RequiredPermission', headerName: 'Request Category', sortable: true, filter: true },
          {
            ...
            cellRenderer: (params:any)=>{
              return `<button type="button" class="btn btn-outline-info btn-rounded btn-sm" mdbRipple rippleColor="dark">Review</button>`;
            },
            onCellClicked: (params: any) => {
              this.router.navigate(['/request-approval', params.data.Id]);
            }
          },
          //{
